...
\newcommand{\Fspec}{
  \begin{figure*}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
      ...
      \caption{}
    \end{subfigure}
    \caption{\textcolor{red}{[Place holder figure, the plan is to redo these as filled contours with levels scaled to the result for massless free fields in de Sitter and over plot with the linear calculation of the spectra.]}}
    \label{fig:spec}
  \end{figure*}
}
