...
\newcommand{\Fspec}{
  \begin{figure*}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
      ...
      \caption{}
    \end{subfigure}
    \caption{\textcolor{red}{[Place holder figure, the plan is to redo these as filled contours with levels scaled to the result for massless free fields in de Sitter.]}}
    \label{fig:spec}
  \end{figure*}
}
...
\newcommand{\Fphasespace}{
  \begin{figure*}
    ...
    \begin{subfigure}[b]{0.225\textwidth}
      ...
      \caption{}
    \end{subfigure}
    \caption{Projections of the position marginalized phase space taken on a \textcolor{red}{[mention time slice at the end of $\Delta V$]} time slice. \textcolor{red}{[Mention this is for the same run as shown in the other plots.]} \textcolor{red}{[Explain the difference between the grey and red contours.]}}
...
\newcommand{\Fdeltaps}{
  \begin{figure}
    ...
    \end{subfigure}
    \begin{subfigure}[a]{0.45\textwidth}
      \includegraphics[width=\textwidth]{\FFdeltapsB}
      \caption{}
    \end{subfigure}
    \caption{}
    \label{fig:deltaps}
