  ...
  \begin{figure*}
    \centering
      \begin{subfigure}[a]{\textwidth}
        ...
        \caption{}
      \end{subfigure}
    \caption{Spectra and cross-spectra real parts from a run using the full potential $V=V_0+\Delta V$. From left to right on the top row are $\langle|\tilde{\phi}_k|^2\rangle$, $\mathrm{Re}\langle\tilde{\phi}^*_k\tilde{\Pi}^\phi_k\rangle $, $\langle|\tilde{\Pi}^\phi_k|^2\rangle$, and from felt to right on the bottom row are $\langle|\tilde{\chi}_k|^2\rangle$, $\mathrm{Re}\langle\tilde{\chi}^*_k\tilde{\Pi}^\chi_k\rangle $, $\langle|\tilde{\Pi}^\chi_k|^2\rangle$. The axes and scaling are as in Fig. \ref{fig:specbl}, the vertical dashed blue lines bound the region where $\Delta V$ is nonzero. \\
In comparison to the baseline case shown in Fig. \ref{fig:specbl} the growth of $\langle|\tilde{\chi}_k|^2\rangle$ within the instability band of $\Delta V$ is clearly visible, also associated with this instablity is the growth of $\langle|\tilde{\Pi}^\chi_k|^2\rangle$ and the positive correlation of $\mathrm{Re}\langle\tilde{\chi}^*_k\tilde{\Pi}^\chi_k\rangle$ \textcolor{red}{[part about the growth of $\mathrm{Re}\langle\tilde{\chi}^*_k\tilde{\Pi}^\chi_k\rangle$ being due to matching onto the `growing mode' of this instability]}.
\textcolor{red}{[Stuff about coherent oscillations and the banded structure after $\Delta V$.]} \\
The deviationof $\langle|\tilde{\phi}_k|^2\rangle$, $\mathrm{Re}\langle\tilde{\phi}^*_k\tilde{\Pi}^\phi_k\rangle $, and $\langle|\tilde{\Pi}^\phi_k|^2\rangle$ from the baseline case shown in Fig. \ref{fig:specbl} is an effect not predicted by linear theory around a $\langle\chi\rangle=0$ background. We find the origins of this nonlinear effect are more readily exlained in real space rather than Fourier space.}
    \label{fig:spec}
  \end{figure*}
}
