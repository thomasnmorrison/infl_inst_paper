...
\marginpar{
  Give operator splitting (maybe appendix material).
}
\marginpar{
  Now talking about putting these equations on the lattice so need to say how $\nabla$ and $\nabla^2$ are defined on the lattice (maybe appendix material).
}
